            ...
            <div className="text-center space-y-8">
              <div>
                ...
                <p className="text-gray-500 mt-2">
                  Pilih peran yang sesuai untuk mendaftar akun baru
                </p>
              </div>
              ...
              <div className="grid grid-cols-1 gap-4 w-full">
                ...
                >
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Saya ingin mencari pekerjaan impian
                  </p>
                </button>

                <button
                  onClick={() => setRegisterRole("recruiter")}
                  className="group relative overflow-hidden rounded-xl border-2 border-gray-100 bg-white p-6 hover:border-purple-500 hover:shadow-xl transition-all duration-300 text-left w-full"
                >
                  <div className="flex items-start justify-between">
                  ...
                  <p className="mt-1 text-sm text-gray-500">
                    Saya ingin merekrut talenta terbaik
                  </p>
                </button>
              </div>
            ...
            <div className="text-left w-full">
              ...
              <form onSubmit={handleRegisterSubmit} className="space-y-4">
                ...
                {regErrors.agreeTerms && (
                  <p className="text-red-500 text-xs">{regErrors.agreeTerms}</p>
                )}
      ...
      >
        ...
        <div className="relative z-20 flex flex-col justify-between w-full p-12 text-white h-full">
          <div>
            <Link
              href="/"
              className="flex items-center gap-3 text-white/90 hover:text-white transition-colors w-fit"
            >
          ...
          <div className="space-y-6">
            ...
            <p className="text-lg text-blue-100 max-w-md leading-relaxed">
              ...
              kesuksesan karir mereka bersama Disnaker.
            </p>
          </div>

          <div className="flex items-center gap-4 text-sm text-blue-200">
            <span>© {new Date().getFullYear()} Disnaker</span>
