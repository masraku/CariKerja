...
const CompaniesPage = () => {
    ...
    return (
        <div className="min-h-screen bg-gray-50">
            {/* Hero Section */}
            <div className="relative bg-blue-600 overflow-hidden px-4 lg:px-8 py-16 lg:py-24">
                ...
                <div className="relative max-w-5xl mx-auto text-center z-10">
                    ...
                    <p className="text-blue-100 text-lg lg:text-xl mb-10 max-w-2xl mx-auto">
                        Temukan perusahaan impianmu dan bergabunglah dengan tim luar biasa yang sedang membangun masa depan.
                    </p>
                    ...
                    <div className="flex justify-center gap-8 lg:gap-16 mt-12">
                        <div className="text-center">
                            <div className="text-3xl lg:text-4xl font-bold text-white mb-1">{companies.length}</div>
                            <div className="text-sm text-blue-200 font-medium uppercase tracking-wider">Perusahaan</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl lg:text-4xl font-bold text-emerald-400 mb-1">{totalActiveJobs}</div>
                            <div className="text-sm text-blue-200 font-medium uppercase tracking-wider">Lowongan Aktif</div>
                        </div>
                        <div className="text-center">
                            <div className="text-3xl lg:text-4xl font-bold text-pink-400 mb-1">{followedCompanies.length}</div>
                            <div className="text-sm text-blue-200 font-medium uppercase tracking-wider">Diikuti</div>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div className="max-w-7xl mx-auto px-4 lg:px-8 py-12 -mt-8 relative z-20">
                ...
                <div className="mb-6 flex items-center justify-between">
                    <p className="text-gray-500">
                        Menampilkan <span className="font-bold text-gray-900">{companies.length}</span> perusahaan
                    </p>
                </div>
                ...
                {loading ? (
                    ...
                    <div className="bg-white rounded-2xl shadow-sm border border-gray-100 p-16 text-center">
                        ...
                        <p className="text-gray-500 mb-8">Coba ubah filter pencarian Anda untuk menemukan hasil yang lebih baik</p>
                        <button
                    ...
                    <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                        {companies.map(company => (
                            <div key={company.id} className="bg-white rounded-2xl shadow-sm border border-gray-100 overflow-hidden hover:shadow-xl hover:shadow-blue-500/5 hover:border-blue-200 transition-all duration-300 group flex flex-col h-full">
                                {/* Card Header */}
                                ...
                                <div className="p-6 pt-0 flex-1 flex flex-col relative">
                                    ...
                                    <div className="mb-1">
                                        ...
                                        {company.tagline && (
                                            <p className="text-sm text-gray-500 truncate mt-1">{company.tagline}</p>
                                        )}
                                    </div>
                                    ...
                                    <div className="space-y-3 mb-6 flex-1">
                                        ...
                                        <div className="flex items-center gap-3 text-sm text-gray-600">
                                            ...
                                            <span className="font-medium">{company.companySize} karyawan</span>
                                        </div>
                                        <div className="flex items-center gap-3 text-sm text-gray-600">
                                            <div className="w-8 h-8 rounded-lg bg-blue-50 flex items-center justify-center flex-shrink-0 text-blue-500">
                                                <Briefcase className="w-4 h-4" />
                                            </div>
                                            <span className="text-blue-600 font-bold">{company.activeJobs} lowongan aktif</span>
                                        </div>
                                    </div>
                                        ...
                                        <div className="flex items-center gap-2 mb-6 bg-amber-50 p-2 rounded-lg w-fit">
                                            <div className="flex">
                                                {[...Array(5)].map((_, i) => (
                                                    <Star
                                                        key={i}
                                                        className={`w-3.5 h-3.5 ${i < Math.floor(company.rating) ? 'text-amber-400 fill-amber-400' : 'text-gray-300'}`}
                                                    />
                                                ))}
                                            </div>
                                            <span className="text-xs font-bold text-amber-700">
                                                {company.rating} <span className="font-normal text-amber-600">({company.reviews})</span>
                                            </span>
                                        </div>
                                    )}
