...
import { 
    ...
    Banknote, CheckCircle, ArrowRight, ArrowLeft, Clock, Globe
} from 'lucide-react'
    ...
    const JobCard = ({ job, isSelected }) => (
        ...
        >
            <div className="flex gap-4">
                <div className="w-14 h-14 rounded-xl bg-slate-50 flex items-center justify-center overflow-hidden flex-shrink-0 border border-slate-100">
                    ...
                    <section>
                        ...
                        <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3">
                            {job.benefits.map((benefit, index) => (
                                <li key={index} className="flex items-center gap-3 p-3 rounded-xl bg-slate-50 border border-slate-100 text-slate-700">
        ...
        <div className="min-h-screen bg-slate-50 pt-24 pb-12">
            <div className="container mx-auto px-4 sm:px-6 lg:px-8 h-[calc(100vh-8rem)]">
                <div className="flex gap-6 h-full">
                            ...
                            {showFilters && (
                                <div className="p-4 bg-white rounded-2xl border border-slate-200 shadow-sm animate-in slide-in-from-top-2">
                                    <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                                        <div>
                                            <label className="block text-sm font-medium text-slate-700 mb-2">Tipe Pekerjaan</label>
                        ...
                        <div className="flex-1 overflow-y-auto custom-scrollbar pr-2 space-y-3">
                            {loading ? (
                                ...
                                <div className="text-center py-12">
                                    ...
                                    <h3 className="text-lg font-bold text-slate-900">Tidak ada lowongan ditemukan</h3>
                    ...
                    <div className={`lg:w-[600px] xl:w-[700px] bg-white rounded-3xl border border-slate-200 shadow-xl shadow-slate-200/50 overflow-hidden flex flex-col ${
                        ...
                        {selectedJob ? (
                            ...
                            <div className="h-full flex flex-col items-center justify-center text-center p-8 text-slate-400">
                                ...
                                <h3 className="text-xl font-bold text-slate-900 mb-2">Pilih Lowongan</h3>
                                <p className="max-w-xs mx-auto">Pilih salah satu lowongan dari daftar di samping untuk melihat detail lengkapnya.</p>
                            </div>
                        )}
                    </div>
                </div>
