...
export default function JobseekerInterviewsPage() {
  ...
  const handleRespond = async (participantId, status) => {
    ...
    try {
      ...
      if (isAccept) {
        successText =
          "Konfirmasi kehadiran berhasil. Rekruter akan menerima notifikasi.";
      } else if (isReschedule) {
        successText =
          "Permintaan reschedule telah dikirim. Tunggu konfirmasi dari rekruter.";
      } else {
  ...
  const getFilteredInterviews = () => {
    ...
    if (activeFilter === "declined")
      return {
        pending: [],
        responded: responded.filter((i) => i.status === "DECLINED"),
      };
    if (activeFilter === "reschedule")
      return {
        pending: [],
        responded: responded.filter((i) => i.status === "RESCHEDULE_REQUESTED"),
      };
      ...
      <div className="container mx-auto px-4 max-w-6xl">
        ...
        <div className="mb-8">
          ...
          <p className="text-gray-600">
            Kelola jadwal interview dan konfirmasi kehadiran Anda
          </p>
        </div>
                  ...
                  <div className="flex flex-col md:flex-row gap-6">
                    ...
                    <div className="flex-1">
                      ...
                      <div className="flex flex-wrap gap-3">
                        <button
                          onClick={() =>
                            handleRespond(interview.participantId, "ACCEPTED")
                          }
                        ...
                        <button
                          onClick={() =>
                            handleRespond(interview.participantId, "DECLINED")
                          }
            ...
            <div className="space-y-4">
              {filteredData.responded
                ...
                .map((interview) => (
                  <div
                    key={interview.participantId}
                    className="bg-gradient-to-r from-orange-50 to-amber-50 border-2 border-orange-300 rounded-2xl p-6 shadow-lg"
                  >
                    <div className="flex flex-col md:flex-row gap-6">
                      <div className="flex-shrink-0">
                        <div className="w-16 h-16 bg-gradient-to-br from-[#03587f] to-[#024666] rounded-xl flex items-center justify-center text-3xl overflow-hidden">
                      ...
                      <div className="flex-1">
                        ...
                        <div className="bg-orange-100 border border-orange-200 rounded-lg p-4">
                          <p className="text-sm text-orange-800">
                            <strong>
                              ⏳ Permintaan reschedule telah dikirim
                            </strong>
                            <br />
        ...
        {filteredData.responded.filter((i) => i.status === "ACCEPTED").length >
          0 && (
          <div className="mb-8">
            <h2 className="text-xl font-bold text-gray-900 mb-4">
              Interview Terkonfirmasi
            </h2>
            <div className="space-y-4">
              {filteredData.responded
                    ...
                    <div className="flex flex-col md:flex-row gap-6">
                      ...
                      <div className="flex-1">
                        ...
                        {canJoinNow(interview.scheduledAt) ? (
                          ...
                          <button
                            disabled
                            className="w-full bg-gray-300 text-gray-600 px-6 py-3 rounded-lg cursor-not-allowed font-semibold flex items-center justify-center gap-2"
                          >
                            <Video className="w-5 h-5" />
        ...
        {/* Declined Interviews */}
        {filteredData.responded.filter((i) => i.status === "DECLINED").length >
          0 &&
          activeFilter === "declined" && (
            <div className="mb-8">
              <h2 className="text-xl font-bold text-gray-900 mb-4">
              ...
              <div className="space-y-4">
                {filteredData.responded
                  ...
                  .map((interview) => (
                    <div
                      key={interview.participantId}
                      className="bg-gray-100 rounded-2xl p-6 border border-gray-300"
                    >
                      <div className="flex flex-col md:flex-row gap-6">
                        <div className="flex-shrink-0">
        ...
        {interviews.length === 0 && (
          <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
            ...
            <p className="text-gray-600 mb-6">
              Anda belum memiliki jadwal interview. Terus lamar pekerjaan untuk
              mendapatkan interview!
            </p>
            <Link href="/jobs">
        ...
        {interviews.length > 0 &&
          filteredData.pending.length === 0 &&
          filteredData.responded.length === 0 && (
            <div className="bg-white rounded-2xl shadow-lg p-12 text-center">
