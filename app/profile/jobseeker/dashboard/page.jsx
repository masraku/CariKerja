  ...
  return (
    <div className="min-h-screen bg-gray-100 pt-24 pb-12">
      <div className="max-w-7xl mx-auto px-4 sm:px-6">
        {/* Hero Card */}
        <div className="bg-gradient-to-br from-primary via-primary to-primary-hover rounded-3xl p-6 md:p-8 shadow-2xl shadow-primary/20 relative overflow-hidden mb-8">
          {/* Abstract Shapes */}
          ...
          <div className="space-y-6">
            ...
            <div className="bg-white rounded-2xl shadow-lg shadow-gray-200/50 p-6 border border-gray-100">
              ...
              <div className="space-y-3">
                <button
                  onClick={() => router.push("/jobs")}
                  className="w-full flex items-center justify-between p-4 rounded-xl bg-gradient-to-r from-primary to-primary-hover text-primary-foreground shadow-lg shadow-primary/20 hover:shadow-xl hover:-translate-y-0.5 transition group"
                >
