...
export default function JobseekerApplicationsPage() {
    ...
    const viewDetails = async (applicationId) => {
        try {
            ...
            if (result.success) {
                ...
                alert(result.error || 'Gagal memuat detail')
            }
        } catch (error) {
    ...
    // Status tabs
    const statusTabs = [
        { key: 'ALL', label: 'Semua', count: Object.values(stats).reduce((a, b) => a + b, 0) },
        { key: 'PENDING', label: 'Pending', count: stats.PENDING || 0 },
        { key: 'REVIEWING', label: 'Reviewing', count: stats.REVIEWING || 0 },
                    ...
                    <div className="bg-white rounded-lg shadow-sm p-6">
                        <div className="flex items-center justify-between">
                            <div>
                                ...
                                <p className="text-3xl font-bold text-gray-900 mt-1">
                                    {(stats.PENDING || 0) + (stats.REVIEWING || 0) + (stats.SHORTLISTED || 0)}
                                </p>
                            </div>
                    ...
                    <div className="flex gap-2 overflow-x-auto pb-2">
                        {statusTabs.map(tab => (
                            <button
                                ...
                                className={`px-4 py-2 rounded-lg whitespace-nowrap transition ${selectedStatus === tab.key
                                        ...
                                        <div className="flex gap-4 flex-1">
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="flex items-center gap-2">
                                                    <span className={`inline-flex items-center gap-1 px-3 py-1 rounded-full text-sm font-medium ${statusConfig[application.status].color}`}>
                                    ...
                                    {application.recruiterNotes && (
                                        <div className="mt-4 pt-4 border-t border-gray-200">
                                            <p className="text-sm text-gray-600">
                                                <span className="font-medium">Catatan Recruiter:</span> {application.recruiterNotes}
                                            </p>
                                        </div>
                                    )}
                                </div>
                            ...
                            <div className="p-6">
                                    ...
                                    <div className="space-y-4">
                                        <div className="flex gap-4">
                                            ...
                                            <div className="pb-6">
                                                ...
                                                <p className="text-sm text-gray-600">{formatDate(selectedApplication.appliedAt)}</p>
                                            </div>
                                        </div>
                                        ...
                                        {selectedApplication.interviewDate && (
                                            <div className="flex gap-4">
                                                ...
                                                <div>
                                                    ...
                                                    <p className="text-sm text-gray-600">{formatDate(selectedApplication.interviewDate)}</p>
                                                </div>
                                            </div>
                                        )}
                                    </div>
                                ...
                                {selectedApplication.recruiterNotes && (
                                    <div className="mb-6 p-4 bg-blue-50 rounded-lg">
                                        <h4 className="font-semibold text-gray-900 mb-2">Catatan Recruiter</h4>
                                        <p className="text-gray-600">{selectedApplication.recruiterNotes}</p>
                                    </div>
                                )}
