...
export default function JobApplicationsPage() {
  ...
  const aiRecommendedCount = Object.values(aiRecommendations).filter(
    (r) => r?.isRecommended
  ).length;
  ...
  const handleSelectAll = () => {
    const selectableApps = filteredApplications.filter(
  ...
  const handleInviteInterview = (application) => {
    if (!job?.id) {
      Swal.fire({
        icon: "error",
        title: "Error",
        text: "Data lowongan belum dimuat.",
      });
      return;
    }
    router.push(
        ...
        <div className="flex items-start gap-4">
          ...
          <button
            onClick={() =>
              ...
              openPhotoModal(application.jobseekers.photo, fullName)
            }
            ...
            <div className="flex items-start justify-between gap-2 mb-2">
              <div>
                ...
                <p className="text-sm text-gray-500">
                  {application.jobseekers.currentTitle || "Pencari Kerja"}
                </p>
              </div>
            ...
            <div className="flex flex-wrap items-center gap-2 mb-3">
              <button
                onClick={() =>
                  ...
                  openDocumentModal(application.jobseekers.cvUrl, "CV", "pdf")
                }
              ...
              <button
                onClick={() =>
                  ...
                  openDocumentModal(application.jobseekers.ak1Url, "AK1", "pdf")
                }
    ...
    <div className="min-h-screen bg-gray-50 pt-24 pb-8">
      <div className="container mx-auto px-4 max-w-7xl">
        ...
        <div className="mb-6">
          <button
            onClick={() =>
              router.push(`/profile/recruiter/dashboard/jobs/${params.slug}`)
            }
            ...
            >
              <p
                className={`text-sm mb-1 ${
                  statusFilter === "all" ? "text-gray-300" : "text-gray-600"
                }`}
              >
                Total
              </p>
            ...
            >
              <p
                className={`text-sm mb-1 flex items-center gap-1 ${
                  aiFilter ? "text-amber-100" : "text-amber-700"
                }`}
              >
              ...
              <p
                className={`text-3xl font-bold ${
                  aiFilter ? "text-white" : "text-amber-900"
                }`}
              >
                {aiRecommendedCount}
              </p>
