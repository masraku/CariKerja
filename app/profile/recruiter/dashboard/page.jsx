    ...
    <div className="min-h-screen bg-gray-50 py-8">
      <div className="container mx-auto px-4 max-w-7xl">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-red-800 mb-4">
                    Mohon perbaiki data perusahaan Anda sesuai dengan alasan penolakan di atas, lalu hubungi admin untuk mengajukan verifikasi ulang.
                  </p>
                  <div className="flex gap-3">
                    ...
                    <a
                      href="mailto:support@carikerja.id?subject=Permohonan Verifikasi Ulang Perusahaan"
                      className="inline-flex items-center px-4 py-2 border border-red-300 text-red-700 rounded-lg hover:bg-red-100 transition text-sm font-medium"
                    >
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-amber-800">
                    Akun perusahaan Anda sedang dalam proses verifikasi oleh admin. Anda masih bisa memposting lowongan, namun lowongan akan ditampilkan setelah perusahaan terverifikasi.
                  </p>
                </div>
              </div>
            </div>
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-sm text-green-800">
                    Perusahaan Anda telah terverifikasi. Anda dapat memposting lowongan dan mengakses semua fitur premium.
                  </p>
                </div>
              </div>
            </div>
        ...
        <div className="grid md:grid-cols-2 gap-6 mb-6">
          {company.status === 'REJECTED' ? (
            <div className="bg-gray-100 text-gray-500 p-6 rounded-lg flex items-center justify-between cursor-not-allowed">
              <div className="text-left">
                <h3 className="font-bold text-lg mb-2">Pasang Lowongan Baru</h3>
                <p className="text-sm text-gray-400">Tidak tersedia - Perusahaan perlu diverifikasi ulang</p>
              </div>
