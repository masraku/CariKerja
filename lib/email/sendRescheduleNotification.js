                        ...
                        <table style="width: 100%; border-collapse: collapse;">
                          ...
                          <tr>
                            <td style="padding: 8px 0; vertical-align: top;">
                              <strong style="color: #4b5563;">${isInPerson ? 'Location:' : 'Interview Room:'}</strong>
                            </td>
                            <td style="padding: 8px 0;">
                              ${isInPerson
                                ? `<span style="color: #1f2937; white-space: pre-wrap;">${location}</span>`
                                : `<a href="${process.env.NEXT_PUBLIC_APP_URL || 'http://localhost:3000'}/profile/jobseeker/interviews/${interviewId}" style="color: #2563eb; text-decoration: none; word-break: break-all;">Open interview details</a>`}
                            </td>
                          </tr>
                          ${description ? `
                          <tr>
