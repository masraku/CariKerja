...
const scheduleDaysSchema = z.union([z.string(), z.array(z.string())])
  .optional()
  .nullable()
...
export const createJobSchema = z.object({
  ...
  // Work Schedule
  workingDays: scheduleDaysSchema,
  holidays: scheduleDaysSchema,
  ...
  malePositions: z.union([z.string(), z.number()]).optional().default(0),
  femalePositions: z.union([z.string(), z.number()]).optional().default(0),
...
export const createContractSchema = z.object({
  workers: z.array(z.object({
    ...
    salary: z.union([z.string(), z.number()]).refine((value) => {
      const salary = Number(value)
      return Number.isFinite(salary) && salary > 0
    }, 'Gaji harus berupa angka lebih dari 0'),
    ...
    message: 'Tanggal selesai kontrak harus setelah tanggal mulai',
    path: ['endDate']
...
export const updateJobSchema = z.object({
  ...
  malePositions: z.union([z.string(), z.number()]).optional(),
  femalePositions: z.union([z.string(), z.number()]).optional(),
  applicationDeadline: z.string().optional().nullable(),
  skills: z.array(z.string()).optional(),
...
export const recruiterRescheduleSchema = z.object({
  ...
  participantId: z.string().optional().nullable() // For individual reschedule
})
