...
const logger = pino({
  ...
  // NOTE: Do NOT use pino transport (pino-pretty) here.
  // Pino transports use worker threads (thread-stream), which are
  // incompatible with Next.js webpack bundling and cause:
  // "Cannot find module 'thread-stream/lib/worker.js'" errors.
