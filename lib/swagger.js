...
export const swaggerSpec = {
  ...
  info: {
    ...
    version: '1.0.0',
    description: 'API documentation for CariKerja - Job Portal Platform by Disnaker Kota Cirebon',
    contact: {
      name: 'Disnaker Kota Cirebon',
      url: 'https://carikerja.disnaker-kotacirebon.id'
    },
    license: {
      name: 'Private',
    }
