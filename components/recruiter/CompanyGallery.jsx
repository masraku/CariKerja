...
export default function CompanyGallery({ gallery = [], companyId, onGalleryUpdate }) {
    ...
    return (
        <div>
            <div className="flex items-center justify-between mb-4">
                <div>
                    <h3 className="text-lg font-semibold text-gray-900">Company Gallery</h3>
            ...
            {gallery.length === 0 && !uploading && (
                <div className="text-center py-12 border-2 border-dashed border-gray-200 rounded-lg">
                    ...
                    <p className="text-gray-500">No photos yet. Start building your gallery!</p>
                </div>
            )}
        </div>
    )
