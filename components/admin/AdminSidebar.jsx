...
export default function AdminSidebar() {
    ...
    const menuItems = [
        ...
        { icon: Building2, label: 'Companies', href: '/admin/companies', badge: 'pending' },
        { icon: Users, label: 'Jobseekers', href: '/admin/jobseekers' },
            ...
            <div className="p-6 border-b border-gray-800">
                <Link href="/admin" className="flex items-center gap-2">
                    ...
                    <div>
                        ...
                        <div className="text-xs text-gray-400">JobSeeker</div>
                    </div>
                </Link>
            </div>
