          ...
          <nav className="flex flex-col gap-2">
            ...
            {user ? (
              <>
                ...
                {user.role === 'admin' && (
                  <Link href="/admin" className="px-4 py-3 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 flex items-center gap-3">
                    <LayoutDashboard className="w-4 h-4" /> Dashboard
                  </Link>
                )}
                
                <Link href={`/profile/${user.role}`} className="px-4 py-3 rounded-xl text-sm font-medium text-slate-600 hover:bg-slate-50 flex items-center gap-3">
