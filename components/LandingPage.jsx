        ...
        <div className="min-h-screen bg-gray-50 selection:bg-blue-100 selection:text-blue-900">
            ...
            <section className="relative pt-32 pb-20 lg:pt-48 lg:pb-32 overflow-hidden bg-blue-600">
                ...
                <div className="max-w-5xl mx-auto px-4 lg:px-8 relative z-10 text-center">
                    ...
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-white/10 backdrop-blur-md rounded-full border border-white/20 mb-8 animate-fade-in-up shadow-lg shadow-blue-900/20">
                        ...
                        <span className="text-sm text-white font-medium">Platform Karir Masa Depan</span>
                    </div>

                    {/* Main Heading */}
                    <h1 className="text-5xl lg:text-7xl font-bold tracking-tight text-white mb-6 leading-tight drop-shadow-sm">
                        Temukan Karir <br />
                        <span className="text-transparent bg-clip-text bg-gradient-to-r from-blue-200 to-indigo-200">Impianmu</span> Disini
                    </h1>

                    <p className="text-lg lg:text-xl text-blue-100 mb-10 max-w-2xl mx-auto leading-relaxed font-light">
                        Hubungkan potensimu dengan ribuan perusahaan terkemuka. 
                        Karir cemerlang dimulai dari langkah yang tepat.
                    </p>

                    {/* Search Bar */}
                    <form onSubmit={handleSearch} className="max-w-2xl mx-auto mb-16 relative z-20">
                    ...
                    {!loading && stats && (
                        <div className="grid grid-cols-3 gap-4 max-w-3xl mx-auto">
                            {[
                                { label: 'Lowongan Aktif', value: stats.totalJobs, color: 'text-white' },
                                { label: 'Perusahaan', value: stats.totalCompanies, color: 'text-white' },
                                { label: 'Talenta Diterima', value: stats.totalHires, color: 'text-white' }
                            ].map((stat, i) => (
                                <div key={i} className="bg-white/10 backdrop-blur-md border border-white/10 rounded-2xl p-4 lg:p-6 shadow-lg">
                                    <div className={`text-2xl lg:text-4xl font-bold ${stat.color} mb-1`}>
                                        {stat.value?.toLocaleString() || '0'}+
                                    </div>
                                    <div className="text-sm text-blue-200 font-medium uppercase tracking-wider">{stat.label}</div>
                                </div>
                            ))}
                        </div>
                    )}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="flex flex-wrap items-end justify-between gap-4 mb-12">
                        <div>
                            ...
                            <p className="text-gray-500 text-lg">Peluang karir terbaik minggu ini</p>
                        </div>
                        <Link 
                            href="/jobs"
                    ...
                    {loading ? (
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {[1, 2, 3, 4, 5, 6].map(i => (
                                <div key={i} className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm h-48 animate-pulse"></div>
                            ))}
                        </div>
                    ) : (
                        <div className="grid md:grid-cols-2 lg:grid-cols-3 gap-6">
                            {featuredJobs.map(job => (
                                <Link
                                    key={job.id}
                                    href={`/jobs/${job.slug}`}
                                    className="group bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-xl hover:shadow-blue-500/5 hover:border-blue-100 transition-all duration-300 flex flex-col h-full"
                                >
                                    ...
                                    <div className="flex items-center gap-2 text-gray-500 text-sm mb-6 flex-1">
            ...
            <section className="px-4 lg:px-8 py-20 lg:py-28 bg-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-500 text-lg">Bergabung dengan tim terbaik di industri</p>
                    </div>
                    ...
                    {loading ? (
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
                            {[1, 2, 3, 4, 5, 6].map(i => (
                                <div key={i} className="bg-gray-50 rounded-2xl h-40 animate-pulse"></div>
                            ))}
                        </div>
                    ) : (
                        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-6 gap-6">
            ...
            <section className="px-4 lg:px-8 py-20 lg:py-28 bg-gray-900 text-white relative overflow-hidden">
                ...
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-16">
                        ...
                        <p className="text-gray-400 text-lg">Hanya butuh 3 langkah sederhana</p>
                    </div>
                            ...
                            return (
                                <div key={i} className="relative group">
                                    ...
                                    <div className="relative bg-gray-800/50 backdrop-blur-sm border border-white/10 p-8 rounded-3xl hover:-translate-y-2 transition-transform duration-300 h-full">
                                        <div className={`w-14 h-14 ${step.color} rounded-2xl flex items-center justify-center mb-6 shadow-lg shadow-${step.color}/20`}>
            ...
            <section className="px-4 lg:px-8 py-20 lg:py-28 bg-white">
                <div className="max-w-5xl mx-auto">
                    <div className="bg-gradient-to-r from-blue-600 to-indigo-600 rounded-[2.5rem] p-8 lg:p-16 text-center relative overflow-hidden shadow-2xl shadow-blue-900/20">
                        ...
                        <div className="relative z-10">
                            ...
                            <p className="text-blue-100 text-lg mb-10 max-w-2xl mx-auto">
                                Jangan lewatkan kesempatan untuk berkembang. Bergabunglah dengan komunitas profesional kami hari ini.
                            </p>
